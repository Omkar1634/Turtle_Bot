...
#************************************************************************************************************************
    ...
    #Function for membership of D
    def D(a,b,c,d,e):
        global D1,D2

        #Minimum of 3 sensor for D1(OA) and Minimum of 2 sensor for D2(REF)
        D1 = min(a,b,c)
        D2 = min(d,e)
    ...
    #Integrated Speed and Turning Calculation formula
...
#************************************************************************************************************************
    ...
    msg.linear.x = -finalspeed #Integrated speed value
    msg.angular.z = finalturning #Integrated Turning value
    return msg
